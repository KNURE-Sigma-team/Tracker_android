...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            // [END get_token]
            Log.e("andstepko", "GCM Registration Token: " + token);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Log.e("andstepko", "sendRegistrationToServer");
        ...
        MyHttpResponse myHttpResponse =
                dataSender.httpPostQuery(Info.TOKEN_SERVER_URL, pairs, Info.WAIT_TIME);

        Log.e("andstepko", "Sending token errorCode==>" + myHttpResponse.getErrorCode() +
