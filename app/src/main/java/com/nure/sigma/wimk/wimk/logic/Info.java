...
import com.nure.sigma.wimk.wimk.FailedSenderService;
...
public class Info {
    ...
    public boolean isFailedSenderServiceRunning(Context context){
        return isMyServiceRunning(FailedSenderService.class, context);
    }
