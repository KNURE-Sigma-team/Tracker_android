...
public class FailedSenderservice extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            Util.logRecord(String.valueOf(Info.getInstance().FAILED_LOCATIONS_LIST.size()));
            if (Info.getInstance().FAILED_LOCATIONS_LIST != null && !Info.getInstance().FAILED_LOCATIONS_LIST.isEmpty()) {
                Util.logRecord(networkInfo.getTypeName());
                ...
                Info.getInstance().FAILED_LOCATIONS_LIST = new ArrayList<>();
